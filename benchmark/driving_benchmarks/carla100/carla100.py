...
class CARLA100(ExperimentSuite):
    ...
    def _poses_town01(self):
        ...
        return [_poses_navigation(), _poses_navigation(), _poses_navigation()]
    ...
    def build_experiments(self):
        ...
        camera.set_position(2.0, 0.0, 1.86)
        ...
        for weather in self.weathers:
            ...
            for iteration in range(len(poses_tasks)):
                ...
                experiment.set(
                    Conditions=conditions, Poses=poses, Task=iteration, Repetitions=1
                )
